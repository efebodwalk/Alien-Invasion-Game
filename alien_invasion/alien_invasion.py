...
class AlienInvasion:
	"""Overall class to manage game asssts and behavior."""

	def __init__(self):
		"""Initialize the game and set up its resources"""
		pygame.init()
	...
	def _check_fleet_edges(self):
		"""respond appropriately if any aliens have reahced an edge"""
	...
	def _update_screen(self):
		"""update images on the screen, and flips to new screen"""
